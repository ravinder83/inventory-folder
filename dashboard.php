...
<?php include 'header.php' ?>
  ...
  <section>
    ...
    <div class="col-xl-6 col-sm-6 col-6 mt-3" style="width:40%;background-color: #fff;">
        <a href="product/items.php" style="text-decoration: none; color:#000;"><div class="row" style="margin-left:10px;">
    ...
    <a href="customer/contacts.php" style="text-decoration: none; color:#000;"><div class="row">
          <div class="col-4 mt-2">
  ...
  <section>
    <div class="row">
    <div class="col-xl-6 col-sm-6 col-6 mt-3" style="width:40%;background-color: #fff;">
        <a href="product/editall.php" style="text-decoration: none; color:#000;"><div class="row" style="margin-left:10px;">
          <div class="col-4 mt-2">
    ...
    <div class="col-xl-6 col-sm-6 col-6 mt-3" style="width:40%;background-color: #fff; position: relative; left:30px;">
    <a href="order/order.php" style="text-decoration: none; color:#000;"><div class="row">
          <div class="col-4 mt-2">
  ...
  <section>
    <div class="row">
    <div class="col-xl-6 col-sm-6 col-6 mt-3" style="width:40%;background-color: #fff;">
        <a href="order/outstanding2.php" style="text-decoration: none; color:#000;"><div class="row" style="margin-left:10px;">
          <div class="col-4 mt-2">
    ...
    <div class="col-xl-6 col-sm-6 col-6 mt-3" style="width:40%;background-color: #fff; position: relative; left:30px;">
    <a href="order/orderdetail.php" style="text-decoration: none; color:#000;"><div class="row">
          <div class="col-4">
