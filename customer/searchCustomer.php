...
if(isset($_POST['search_item'])){
  ...
  if(mysqli_num_rows($sqlquery) > 0){
    while ($row = mysqli_fetch_array($sqlquery)){
      $output .= '<a href="../product/itemdetail.php?itemid='.$row['id'].'" style="text-decoration: none; text-transform:capitalize"><div class="alert alert-dark text-center" role="alert">
